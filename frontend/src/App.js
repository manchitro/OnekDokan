...
import AdminRouter from "./pages/privateRouter/AdminRouter";
import ShopkeeperRouter from "./pages/privateRouter/ShopkeeperRouter";
...
function App() {
	...
	const [profilePicLink, setProfilePicLink] = useState("https://www.biography.com/.image/t_share/MTQyMDA0NDgwMzUzNzcyNjA2/mark-zuckerberg_gettyimages-512304736jpg.jpg");
				...
				<ProfileContext.Provider value={ProfileState}>
					...
					<div className="container">
						<Switch>
							...
							{/* admin private pages */}
							<AdminRouter exact path="/admin" component={AdminPanel} />
							<AdminRouter exact path="/admin/ShopKeepers" component={AdminShopKeeperList} />
							<AdminRouter exact path="/admin/Shops" component={AdminShop} />
							<AdminRouter exact path="/admin/products" component={AdminProducts} />
							<AdminRouter exact path="/admin/customers" component={AdminCustomers} />

							{/* Shopkeeper private pages */}
							<ShopkeeperRouter exact path="/shopKeeper" component={ShopKeeperPanel} />
							<ShopkeeperRouter exact path="/shopKeeper/new" component={ShopKeeperNew} />
							<ShopkeeperRouter exact path="/shopKeeper/product" component={ShopKeeperProduct} />
							<ShopkeeperRouter exact path="/shopKeeper/category" component={ShopKeeperCategory} />
